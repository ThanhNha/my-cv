  ...
  $(document).ready(function () {
    ...
    $(".all-btn").click(function () {
      if ($(this).hasClass("active")) {
        ...
        setTimeout(function () {
          $(".mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li").addClass(
            "visible"
          );
        }, 300);
      }
    ...
    $(".design-btn").click(function () {
      if ($(this).hasClass("active")) {
        ...
        setTimeout(function () {
          $(".mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li").removeClass(
            "visible"
          );
          $(
